package com.laomuji888.compose.core.ui.we.widget.theme
...
import com.laomuji888.compose.core.ui.we.colorscheme.WeThemeColorType.Companion.setWeThemeColorType
import com.laomuji888.compose.core.ui.we.widget.actionsheet.WeActionSheet
import com.laomuji888.compose.core.ui.we.widget.actionsheet.WeActionSheetDialog
import com.laomuji888.compose.core.ui.we.widget.actionsheet.WeActionSheetType
...
fun WeThemeSettingDialog(
    ...
    WeActionSheetDialog(
        ...
        WeThemeTypeSettingDialogColorItem(
            text = stringResource(com.laomuji888.compose.res.R.string.string_theme_dialog_we_theme_system),
        ...
        WeThemeTypeSettingDialogColorItem(
            text = stringResource(com.laomuji888.compose.res.R.string.string_theme_dialog_we_theme_light),
            selectedType = selectedType,
        ...
        WeThemeTypeSettingDialogColorItem(
            text = stringResource(com.laomuji888.compose.res.R.string.string_theme_dialog_we_theme_dark),
            selectedType = selectedType,
        ...
        WeThemeTypeSettingDialogColorItem(
            text = stringResource(com.laomuji888.compose.res.R.string.string_theme_dialog_we_theme_blue),
            selectedType = selectedType,
        ...
        WeActionSheet(
            text = stringResource(com.laomuji888.compose.res.R.string.string_theme_dialog_we_theme_cancel),
            onClick = {
                hide { onDismissRequest() }
            },
        )
