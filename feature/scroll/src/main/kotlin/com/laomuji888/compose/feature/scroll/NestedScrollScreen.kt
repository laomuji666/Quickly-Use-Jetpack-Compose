...
internal fun NestedScrollScreen(){
    ...
    WeScaffold(
        ...
        WeClick(
            title = stringResource(com.laomuji888.compose.res.R.string.string_demo_screen_scroll_connect),
            onClick = {
        ...
        WeClick(
            title = stringResource(com.laomuji888.compose.res.R.string.string_demo_screen_scroll_dispatcher),
            onClick = {
