...
import com.laomuji888.compose.core.logic.location.Locator
import com.laomuji888.compose.core.logic.location.LocatorResult
...
class DeviceDemoScreenViewModel @Inject constructor(
    ...
    private fun switchAliasActivity(context: Context, isDynamicAlias: Boolean) {
        val defaultAliasCls = "com.laomuji888.compose.DefaultAliasActivity"
        val dynamicAliasCls = "com.laomuji888.compose.DynamicAliasActivity"
